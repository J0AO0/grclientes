...
create table pedido (id integer not null auto_increment, nf integer, arquiteto_id integer, cliente_id integer, produto_id integer, tenant_id integer, vendedor_id integer, primary key (id)) engine=InnoDB;
...
create table vendedor (id integer not null auto_increment, nome varchar(255), arquiteto_id integer, tenant_id integer, primary key (id)) engine=InnADB;
...
alter table pedido add constraint FKnfnumt91jw5iy549u4towspms foreign key (arquiteto_id) references arquiteto (id);
...
alter table pedido add constraint FKi6y72r3lhf410eb1mqbr41bwv foreign key (vendedor_id) references vendedor (id);
